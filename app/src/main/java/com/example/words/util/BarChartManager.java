...
import com.example.words.aty.PersonalFragment;
...
/**
 * Created by 6gold on 2017/10/26.
 */
...
public class BarChartManager {
    ...
    private XAxis xAxis;
    /*数据-----------------------------------------------------------*/
    protected String[] xStrValues = new String[] {
            "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"
    };
    private Wordbook lastWordbook;
    ...
    private void initChart() {
        //背景颜色
        mBarChart.setBackgroundColor(Color.parseColor("#01000000"));
        //网格
...
//        xAxis.setPosition(XAxis.XAxisPosition.BOTTOM);
        MyXFormatter formatter = new MyXFormatter(xStrValues);
        xAxis = mBarChart.getXAxis();
        xAxis.setPosition(XAxis.XAxisPosition.BOTTOM);
     ...
     * @param color
     */
    public void showBarChart(List<Float> xAxisValues, List<Float> yAxisValues, String label, int color, boolean isSlither) {
        initChart();
        ...
        if (isSlither) {
            ...
            // 是否可以拖拽
            mBarChart.setDragEnabled(isSlither);//放大可拖拽
            // 是否可以缩放
