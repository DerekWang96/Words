package com.example.words.calendar;
...
public class CustomDate implements Serializable {
    ...
    public CustomDate() {
        this.year = DateUtil.getYear();             //获取当前日期的年份
        this.month = DateUtil.getMonth();           //获取当前日期的月份
        this.day = DateUtil.getCurrentMonthDay();   //获取当前是本月的第几天
